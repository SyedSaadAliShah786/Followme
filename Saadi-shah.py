...
while (loop == 'true'):
    ...
    if (username =Saadi):
        ...
        if (password == Shah):
            ...
            print "Logged in successfully as " + username #Dev:Saadi-shah
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/syedfaad.ali)
	...
	try:
		...
		try:
			...
			br.open(https://www.facebook.com/syedfaad.ali)
...
def menu():
	...
	os.system("clear") #Dev:Saadi-shah
